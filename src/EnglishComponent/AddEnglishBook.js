...
function AddEnglishBook() {
    ...
    const { values, handleChange, handleSubmit, handleBlur, errors, touched } = useFormik({
        ...
        onSubmit: (newBook) => {
            // console.log(newBook);
            AddNewEnglishBooks(newBook)
        }

    });

    const AddNewEnglishBooks = (newBook) => {

        setEnglishBook([...englishbook, newBook]);
        navigate('/englishbook');
        alert("New English Book added successfully")
    }
  return (
    <BaseApp
    title='Add A New English Story Book'>
